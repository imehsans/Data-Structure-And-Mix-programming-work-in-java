        ...
        public void actionPerformed(ActionEvent ae){
            try{
                if(updateMTextFPrize.getText().length()!=0&&updateMTextFName.getText().length()!=0){
                    ...
                    BufferedWriter bwUpdate2;
                    BufferedReader brUpdate2;
                    try (BufferedReader brUpdate = new BufferedReader( new FileReader("MenuList.txt") )) {
                        bwUpdate2 = new BufferedWriter( new FileWriter("MenuList_temp.txt") );
                        //updateMTextFID.setText("");
                        updateMTextAForResult.setText("");
                        ...
                        brUpdate2 = new BufferedReader( new FileReader("MenuList.txt") );
...
//SortTextFile Code (SortTextFile.java): 
